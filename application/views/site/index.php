...
<body>
	...
	<!--reservation-->
	<div class="reservation book-right" id="reservation">
		<div class="container">
			...
			<div class="book-right1">
				<form action="<?= base_url(); ?>site/reservation" method="post" id="res" class="book-right2">
					...
					<div >
						...
						<input type="text" placeholder="Full Name" name="name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Full Name';}"
						required="">
					</div>
					<div >
						<label>Banquet Hall :</label>
						<select required name="hall">
							<?php foreach ($banquets as $key => $banquet): ?>
								<option value="<?= $banquet['name'] ?>"><?= $banquet['name'] ?></option>
							<?php endforeach; ?>
						</select>
					</div>
					...
					<div class="form-left">
						...
						<select required="" name="no_of_people">
							<option value="100">100 Person</option>
							<option value="200">200 </option>
							<option value="300">300 </option>
							<option value="More than 300">More</option>
						</select>
					</div>
					...
					<div class="phone-info">
						...
						<input type="text" name="contact" placeholder="Phone Number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Contact';}"
						required="">
					</div>	
					<input type="submit" value="Book Your Banquet">
				</form>
			</div>
				...
				<div class="footer_grid_bottom contact">
					<ul>
						...
						<li>
							...
							<p>1234k Avenue, 4th block,Model Town, Lahore, Pakistan.</p>
						</li>
					</ul>
					<div class="clearfix"></div>
				</div>
